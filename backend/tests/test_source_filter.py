"""Verify source-file classification for code, context, and skipped paths.

Covers ``application.ingestion.source_filter`` helpers that decide which files
are ingestible and how README, requirements, Dockerfile, and lock files are handled.
"""

from pathlib import Path
from application.ingestion.source_filter import classify_ingestible_file, is_ingestible_source_file, iter_ingestible_files
